...
- [x] Task 1: Update project configuration for desktop targets only
...
- [x] Task 2: Configure dependency injection and services
  - File: `MauiProgram.cs`
...
- [x] Task 3: Create project structure folders
...
- [x] Task 4: Create Docker development environment
...
- [x] Task 5: Implement MongoDB connection service
...
- [x] Task 7: Create connection ViewModel
...
- [x] Task 8: Create collections ViewModel
...
- [x] Task 9: Create documents ViewModel
...
- [x] Task 10: Update AppShell for navigation (minimal)
...
- [x] Task 11: Create collections page
...
- [x] Task 12: Create connection page
...
- [x] Task 13: Create documents page
...
- [x] Task 14: Create document detail page
...
- [x] Task 15: Create document detail ViewModel
...
- [x] Task 16: Complete AppShell navigation and finalize
...
#### Sprint 1 : MVP Connectivity
- [x] AC 1: Given the app is launched, when the user enters valid MongoDB connection details, then the app successfully connects and displays available collections
- [x] AC 2: Given Docker environment is running, when `docker-compose up`, then MongoDB accessible at mongodb://admin:password@localhost:27017/testdb

#### Sprint 2 : Functional Exploration
- [x] AC 3: Given a connection is established, when the user selects a collection, then the app displays the list of collections with document counts
- [x] AC 4: Given a collection is selected, when the user opens it, then the app displays the list of documents with basic preview information

#### Sprint 3 : Complete Manipulation
- [x] AC 5: Given a document is selected, when the user clicks on it, then the app displays the full document content in an editable JSON format
- [x] AC 6: Given a document is being viewed, when the user modifies JSON content and saves, then the changes are persisted to MongoDB and reflected in the document list
- [x] AC 7: Given a document is being viewed, when the user deletes the document, then the document is removed from MongoDB and no longer appears in the list

#### Sprint 4 : Production Ready
- [x] AC 8: Given invalid MongoDB connection details, when the user attempts to connect, then the app displays appropriate error messages
- [x] AC 9: Given network connectivity issues, when MongoDB operations fail, then the app handles errors gracefully without crashing
- [x] AC 10: Given the app is running on Windows or MacCatalyst, when the user navigates between screens, then all navigation works correctly using Shell navigation
